...
| [`recruiting-screening-assistant`](recruiting-screening-assistant/README.md) | Preparing recruiting phone-screen scripts and turning post-call notes into candidate evaluations. | `powershell -ExecutionPolicy Bypass -File recruiting-screening-assistant\scripts\reset-local-context.ps1` |
