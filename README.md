...
| [`elite-tech-resume-shortlist`](elite-tech-resume-shortlist/SKILL.md) | Building auditable two-tier technical and product shortlists with strict education-chain, big-company, role-family, and optional explicit-age checks. | No setup required |
