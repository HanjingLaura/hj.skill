...
| [`elite-tech-resume-shortlist`](elite-tech-resume-shortlist/SKILL.md) | Building auditable two-tier technical shortlists with strict education-chain, big-company, role, and optional explicit-age checks. | No setup required |
